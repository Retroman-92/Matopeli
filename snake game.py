...
def start_game():
    canvas.fill(BLACK)
    start_font1 = large_font.render("Tervetuloa Matopeliin", True, BLUE)
    start_font2 = medium_font.render("Pelaa", True, BLACK, GREEN)
    start_font3 = medium_font.render("Ohjeet", True, BLACK, GREEN)
    start_font4 = medium_font.render("Poistu", True, RED, GREEN)
...
def start_inst(start_font1, start_font1_rect):
    canvas.fill(BLACK)
    canvas.blit(start_font1, start_font1_rect)
    start_inst1 = small_font.render("--> Älä osu reunoihin,muuten kuolet", True, BLUE)
    start_inst2 = small_font.render("--> Syö omenia niin saat pisteitä", True, BLUE)
    start_inst3 = small_font.render("--> ............", True, BLUE)
    start_inst4 = small_font.render("--> ......", True, BLUE)
...
def gameover():
    ...
    font_gameover1 = large_font.render('Peli ohi', True, GREEN)
    font_gameover2 = medium_font.render("Pelaa uudestaan", True, RED, YELLOW)
    font_gameover3 = medium_font.render("Poistu", True, RED, YELLOW)
...
def gameloop():
    ...
    while True:
        ...
        LEAD_Y = 100
        direction = 'right'
        score = small_font.render("Pisteet:0", True, YELLOW)
        ...
        while True:
            ...
            if snake_head_rect.colliderect(apple_rect):
                ...
                APPLE_Y = random.randrange(TOP_WIDTH, WINDOW_HEIGHT - 10, 10)
                snakelength += 1
                score = small_font.render("Pisteet:" + str(snakelength - 3), True, YELLOW)
